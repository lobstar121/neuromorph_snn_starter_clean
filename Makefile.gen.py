# Makefile.gen.py — regenerate a clean Makefile without TAB/CRLF issues
...
open("Makefile.bak","wb").write(open("Makefile","rb").read() if __import__("os").path.exists("Makefile") else b"")
open("Makefile","w",encoding="utf-8",newline="\n").write(content)
print("[gen] Wrote clean Makefile (backup: Makefile.bak)")
